          ...
          <a href="javascript:void(0)">
            <div v-bind:class="{'course-card-container':1,'course-card-last':index==4}">
              ...
              <div class="course-card-content">
                <h3 class="course-card-name">{{item.htitle}}</h3>
                <p>{{item.ptitle}}</p>
                <div class="course-card-bottom">
                  <div class="course-card-info"> 高级
                    <span>·</span>5人在学
                  </div>
                </div>
              </div>
...
export default {
  data() {
    ...
    return {
      ...
      goodCourseList: [
        {
          name: "java",
          color: "brow",
          htitle: "带您完成神秘的涟漪按钮效果-入门篇",
          ptitle: "安卓声音录制与播放功能实现，包括录制到文件、播放文件"
        },
        {
          name: "java",
          color: "brow",
      ...
      banner:[
        ...
        {image: "../../static/images/c4.jpg"},
        {image: "../../static/images/c5.jpg"}
      ],
      imgIndex: 1,
      swiperOption: {
        notNextTick: true,
  ...
  methods: {},
  created() {
    axios.get("http://192.168.1.103:8080/course/list").then(response => {
